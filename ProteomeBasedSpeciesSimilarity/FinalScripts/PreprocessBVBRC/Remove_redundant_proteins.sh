...
JOBS_PER_CHUNK=64              # number of concurrent tasks per chunk
NUM_JOBS=64                    # number of parallel CD-HIT jobs
...
if [ "\$seq_count" -gt 1 ]; then
    ...
    cd-hit -i "\$input_file" -o "\$output_file" -c 0.95 -n 5 -M 16000 -d 0;
